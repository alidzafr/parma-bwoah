...
<body>
    ...
    <section class="wrapper">
        <form action="{{route('front.search')}}" method="GET" id="searchForm" class="w-full">
            <input name="keyword" id="searchProduct" type="text" style="background-image: url('{{asset('assets/svgs/ic-search.svg')}}')"
    ...
    <div class="flex flex-col gap-4">
        ...
        <img src="{{Storage::url(($product->photo))}}" class="w-full max-w-[70px] max-h-[70px] object-contain"
            ...
            <div class="flex flex-wrap items-center justify-between w-full gap-1">
                ...
                <a href="{{route('front.product.detail', $product)}}" class="text-base font-semibold stretched-link whitespace-nowrap w-[200px] truncate">
                    {{{$product->name}}}
                </a>
