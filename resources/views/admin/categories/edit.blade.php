    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admincategories.update', $category) }}" class="m-10" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="icon" class="block mt-1 w-full" type="file" name="icon" value="{{$category->icon}}" autocomplete="icon" />
